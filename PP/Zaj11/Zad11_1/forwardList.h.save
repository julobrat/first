...
Panstwa zadaniem jest napisanie listy jednokrotnie wi¹zanej, oraz funkcji do jej obslugi. Nasz ForwardList ma zawieraæ elementy typu T (szczegoly ponizej). Nasza implementacja wzorowana C++owym std::forward_list, aczkolwiek inna niz: http://www.cplusplus.com/reference/forward_list/forward_list/
...
typedef int_fast32_t T;
    ...
    extern "C"
    {
        ...
        ForwardList* constructForwardList(T element);
        ...
        ForwardList* cloneNode(const ForwardList* l);
        ...
        ForwardList* backNode(ForwardList* l);
        ...
        size_t size_impl(const ForwardList* l);
        ...
        void resize_impl(ForwardList* l, size_t newSize);
        ...
        ForwardList* push_front_impl(ForwardList* l, T element);
        ...
        ForwardList* pop_front_impl(ForwardList* l);
        ...
        void assign_impl(ForwardList* l, size_t elementCount, const T elements[]);
        ...
        ForwardList* reverse_impl(ForwardList* l);
        ...
        ForwardList* unique_impl(ForwardList* l);
        ...
        void for_each_impl(ForwardList* l, void(*f)(T* current));
        ...
        ForwardList* remove_if_impl(ForwardList* l, bool(*predicate)(T nodeValue));
